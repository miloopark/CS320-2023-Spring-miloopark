...
let
  ...
  val r1 = rank2int(card_rank(c1))
  val r2 = rank2int(card_rank(c2))
  val r3 = rank2int(card_rank(c3))
  val r4 = rank2int(card_rank(c4))
  val r5 = rank2int(card_rank(c5))
  val (a, b, c, d, e) = int5_sort(r1, r2, r3, r4, r5)
in
  if (a = b andalso b = c andalso d = e) orelse (a = b andalso c = d andalso d = e)
    then true
  else false
end
